            ...
            decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                        color: textFieldBorderColor.withOpacity(0.05))),
                ...
                focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10.0),
                    borderSide: BorderSide(
                        color: textFieldBorderColor.withOpacity(0.8),
                        width: 1)),
                hintText: labelText,
                hintStyle: Get.textTheme.headline4!.merge(const TextStyle(fontSize: 14, color: whiteColor)),
